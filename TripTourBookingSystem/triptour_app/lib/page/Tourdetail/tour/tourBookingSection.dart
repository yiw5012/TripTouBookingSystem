...
class TourBookingSection extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          if (rounds.isEmpty)
            ...
            for (final round in rounds) buildRoundCard(context, round),
        ],
      ),
    );
  }
  ...
  // ==========================================================
  // HANDLE BOOKING (เช็กการล็อกอินก่อนจอง)
  // ==========================================================
  void _handleBooking(BuildContext context, dynamic round) {
    ...
    if (user == null) {
      showDialog(
        ...
        builder: (dialogContext) => AlertDialog(
          ...
          content: const Text('กรุณาเข้าสู่ระบบก่อนทำการจองทัวร์'),
          actions: [
            TextButton(
  ...
  // ROUND CARD
  // ==========================================================
  Widget buildRoundCard(BuildContext context, dynamic round) {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  '${round['departure'] ?? '-'} → ${round['destination'] ?? '-'}',
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Text(
                  '${formatDateText(round['start_date'])} - ${formatDateText(round['end_date'])}',
                ),
              ),
            ],
          ),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Expanded(child: Text('เวลา: ${round['flight_time'] ?? '-'}')),
            ],
          ),
          const SizedBox(height: 7),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Expanded(child: Text('สายการบิน: ${round['airline'] ?? '-'}')),
            ],
          ),
          const SizedBox(height: 7),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              Expanded(child: Text('Flight: ${round['flight'] ?? '-'}')),
            ],
          ),
          ...
          Row(
            children: [
              ...
              ElevatedButton(
                onPressed: isOpen ? () => _handleBooking(context, round) : null,
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.green,
